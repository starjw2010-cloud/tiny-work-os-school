...
const seeds: TermSeed[] = [
  ...
  { slug: "workspace-primary-owner", term: "Workspace Primary Owner", koreanName: "워크스페이스 기본 소유자", category: "admin-security", oneLine: "워크스페이스마다 한 명만 있는 최상위 소유 책임 역할입니다.", businessExample: "워크스페이스 삭제나 소유권 이전처럼 중요한 변경은 기본 소유자 범위를 확인합니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["workspace-owner", "workspace-admin", "role"] },
  { slug: "workspace-owner", term: "Workspace Owner", koreanName: "워크스페이스 소유자", category: "admin-security", oneLine: "워크스페이스의 중요한 설정과 권한을 관리하는 상위 역할입니다.", businessExample: "앱 승인 정책과 멤버 관리 권한을 검토합니다.", sourceId: "roles", screenMockupType: "role-permission", relatedTerms: ["workspace-primary-owner", "workspace-admin", "permission"] },
  { slug: "workspace-admin", term: "Workspace Admin", koreanName: "워크스페이스 관리자", category: "admin-security", oneLine: "멤버 관리와 일부 관리 작업을 돕는 워크스페이스 운영 역할입니다.", businessExample: "게스트 초대와 채널 설정 변경 요청을 처리합니다.", sourceId: "roles", screenMockupType: "role-permission", relatedTerms: ["workspace-owner", "member-management", "guest"] },
  ...
  { slug: "role", term: "Role", koreanName: "역할", category: "admin-security", oneLine: "사용자가 무엇을 볼 수 있고 무엇을 할 수 있는지 결정하는 권한 묶음입니다.", plainExplanation: "Slack의 역할은 단순히 관리자와 일반 사용자로만 나뉘지 않습니다. 워크스페이스 역할, 게스트 역할, 채널 매니저, Enterprise 조직 역할, 시스템 역할처럼 적용 범위가 다릅니다.", businessExample: "Workspace Owner, Admin, Member, Guest, Org Admin, System Role처럼 역할 층을 나눠 설명합니다.", customerTalkTrack: "역할은 이름보다 적용 범위가 중요합니다. 이 역할이 워크스페이스에 적용되는지, 조직에 적용되는지, 특정 관리 기능에만 적용되는지 먼저 확인해야 합니다.", sourceId: "roles", screenMockupType: "role-permission", relatedTerms: ["permission", "workspace-admin", "system-role"] },
  ...
  { slug: "system-role", term: "System Role", koreanName: "시스템 역할", category: "admin-security", oneLine: "Enterprise 구독 맥락에서 특정 관리 작업을 더 세분화해 맡기는 역할입니다.", plainExplanation: "시스템 역할은 모든 관리자 권한을 한 사람에게 주지 않고, 보안·앱·워크플로·사용자 관리처럼 특정 관리 영역만 나누어 맡기는 방식입니다.", easyAnalogy: "회사에서 모든 열쇠를 한 사람에게 주는 대신, 서버실 열쇠·문서고 열쇠·출입증 관리 권한을 담당자별로 나눠주는 것과 비슷합니다.", businessExample: "보안 담당자에게 Security Admin을, 자동화 운영자에게 Workflow Admin을 부여할지 검토합니다.", customerTalkTrack: "시스템 역할은 권한을 넓게 주기보다 필요한 관리 업무만 나눠 맡기기 위한 장치로 설명하면 이해가 빠릅니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["roles-admin", "security-admin", "workflow-admin"] },
  { slug: "custom-role", term: "Custom Role", koreanName: "사용자 지정 역할", category: "admin-security", oneLine: "Enterprise 구독에서 조직의 업무에 맞게 특정 권한 조합을 위임하기 위해 만드는 역할입니다.", plainExplanation: "사용자 지정 역할은 기본 제공 역할만으로 권한 범위를 맞추기 어려울 때, 조직의 운영 방식에 맞게 권한을 조합하는 개념입니다.", businessExample: "지역 운영팀에 채널 관리와 사용자 관리 일부만 맡기는 역할을 설계합니다.", customerTalkTrack: "사용자 지정 역할은 권한을 더 많이 주는 기능이 아니라, 필요한 만큼만 위임하기 위한 거버넌스 도구로 보는 편이 좋습니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["system-role", "roles-admin", "permission"] },
  { slug: "roles-admin", term: "Roles Admin", koreanName: "역할 관리자", category: "admin-security", oneLine: "시스템 역할을 누구에게 할당할지 관리하는 역할입니다.", businessExample: "관리자 권한을 한 사람에게 몰아주지 않고 역할별로 나누어 부여합니다.", sourceId: "roles", screenMockupType: "role-permission", caution: securityCaution, relatedTerms: ["system-role", "custom-role", "permission"] },
  { slug: "security-admin", term: "Security Admin", koreanName: "보안 관리자", category: "admin-security", oneLine: "세션, 계정 비활성화 등 보안 관련 운영 작업을 담당하는 시스템 역할입니다.", businessExample: "의심스러운 로그인이나 퇴사자 계정 처리 기준을 보안 관리자가 확인합니다.", sourceId: "roles", screenMockupType: "security", caution: securityCaution, relatedTerms: ["system-role", "two-factor-authentication", "access-log"] },
  { slug: "workflow-admin", term: "Workflow Admin", koreanName: "워크플로 관리자 역할", category: "admin-security", oneLine: "워크플로 관리와 워크플로 분석 확인을 담당하는 시스템 역할입니다.", businessExample: "부서별 자동화가 늘어날 때 워크플로 운영 권한을 별도로 위임합니다.", sourceId: "roles", screenMockupType: "workflow", caution: workflowCaution, relatedTerms: ["system-role", "workflow-manager", "workflow-activity-log"] },
  { slug: "integrations-admin", term: "Integrations Admin", koreanName: "통합 관리자", category: "admin-security", oneLine: "앱 보기, 설치, 승인, 관리와 관련된 작업을 담당하는 시스템 역할입니다.", businessExample: "새 CRM 앱 설치 요청을 검토하고 승인 정책에 맞는지 확인합니다.", sourceId: "roles", screenMockupType: "marketplace", caution: securityCaution, relatedTerms: ["system-role", "app-management", "app-approval"] },
  { slug: "audit-logs-admin", term: "Audit Logs Admin", koreanName: "감사 로그 관리자", category: "admin-security", oneLine: "감사 로그 접근을 담당하는 시스템 역할입니다.", businessExample: "보안 사고 조사 시 감사 이벤트 확인 권한을 별도로 위임합니다.", sourceId: "roles", screenMockupType: "audit-log", caution: securityCaution, relatedTerms: ["system-role", "audit-log", "security-admin"] },
  { slug: "dlp-admin", term: "DLP Admin", koreanName: "DLP 관리자", category: "admin-security", oneLine: "데이터 손실 방지 설정과 운영을 담당하는 시스템 역할입니다.", businessExample: "외부 메시지와 파일 공유에서 민감정보 노출 정책을 관리합니다.", sourceId: "roles", screenMockupType: "security", caution: planCaution, relatedTerms: ["system-role", "dlp", "slack-connect"] },
  { slug: "users-admin", term: "Users Admin", koreanName: "사용자 관리자", category: "admin-security", oneLine: "비관리자 사용자의 추가, 제거, 비활성화 같은 사용자 운영 작업을 담당하는 시스템 역할입니다.", businessExample: "입퇴사 프로세스에서 계정 생성과 비활성화 작업을 분리해 운영합니다.", sourceId: "roles", screenMockupType: "member-admin", caution: securityCaution, relatedTerms: ["system-role", "member-management", "scim"] },
  { slug: "analytics-admin", term: "Analytics Admin", koreanName: "분석 관리자", category: "admin-security", oneLine: "분석 대시보드 확인을 담당하는 시스템 역할입니다.", businessExample: "채널 활동과 사용량 데이터를 보고 교육이 필요한 영역을 찾습니다.", sourceId: "roles", screenMockupType: "analytics", caution: planCaution, relatedTerms: ["system-role", "data-analytics", "audit-log"] },
  ...
  { slug: "channel-manager", term: "Channel Manager", koreanName: "채널 매니저", category: "admin-security", oneLine: "지정된 채널에서 관리 작업을 맡을 수 있는 유료 구독 기반 역할입니다.", businessExample: "프로젝트 채널 매니저가 주제, 멤버, 운영 규칙을 관리합니다.", sourceId: "roles", screenMockupType: "channel-admin", caution: planCaution, relatedTerms: ["role", "channel-management-tool", "posting-permission"] },
  ...
  { slug: "enterprise-organization", term: "Enterprise Organization", koreanName: "Enterprise 조직", category: "governance", oneLine: "Enterprise 구독에서 여러 워크스페이스와 조직 수준 설정·정책을 함께 관리하는 상위 단위입니다.", plainExplanation: "작은 팀은 하나의 워크스페이스만 이해해도 충분하지만, 큰 조직에서는 여러 워크스페이스를 묶는 Enterprise 조직 개념이 등장할 수 있습니다.", easyAnalogy: "워크스페이스가 개별 지점이라면 Enterprise 조직은 여러 지점을 묶어 정책과 권한을 관리하는 본사에 가깝습니다.", businessExample: "본사, 지역, 사업부 워크스페이스를 조직 정책 아래에서 운영합니다.", customerTalkTrack: "고객이 여러 워크스페이스를 운영하거나 중앙 보안 정책을 묻기 시작하면, Workspace 위에 Enterprise 조직이라는 상위 단위가 있을 수 있다고 설명합니다.", sourceId: "roles", screenMockupType: "enterprise-plus", caution: planCaution, relatedTerms: ["enterprise-plus", "org-primary-owner", "system-role"] },
  ...
  { slug: "org-primary-owner", term: "Org Primary Owner", koreanName: "조직 기본 소유자", category: "admin-security", oneLine: "Enterprise 조직마다 한 명만 있는 최상위 조직 소유 역할입니다.", businessExample: "조직 소유권 이전과 조직 수준 중요 권한을 검토합니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["enterprise-organization", "org-owner", "system-role"] },
  { slug: "org-owner", term: "Org Owner", koreanName: "조직 소유자", category: "admin-security", oneLine: "Enterprise 조직의 상위 관리 책임을 나눠 맡는 조직 단위 소유자 역할입니다.", businessExample: "조직 수준 앱 정책과 워크스페이스 관리 기준을 검토합니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["org-primary-owner", "org-admin", "enterprise-organization"] },
  { slug: "org-admin", term: "Org Admin", koreanName: "조직 관리자", category: "admin-security", oneLine: "Enterprise 조직 수준 설정, 정책, 관리 작업을 돕는 관리자 역할입니다.", plainExplanation: "조직 관리자는 개별 워크스페이스 하나만 보는 역할이 아니라, Enterprise 조직 수준에서 여러 워크스페이스와 정책을 함께 보는 관리자 역할입니다.", businessExample: "워크스페이스 간 정책 적용과 멤버 관리를 지원합니다.", customerTalkTrack: "Org Admin은 Workspace Admin보다 한 단계 넓은 범위를 볼 수 있는 Enterprise 조직 단위 관리자라고 설명하면 좋습니다.", sourceId: "roles", screenMockupType: "role-permission", caution: planCaution, relatedTerms: ["enterprise-organization", "system-role", "workspace-admin"] },
