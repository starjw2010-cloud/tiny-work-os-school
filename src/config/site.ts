export const siteConfig = {
  siteName: "Tiny Work OS School",
  subtitle: "Slack을 처음 배우는 사람들을 위한 작은 용어 학교",
  ...
  unofficialNotice:
    "이 사이트는 Slack 학습을 돕기 위한 비공식 교육용 자료입니다. Slack Technologies, LLC와 공식 제휴 또는 후원 관계가 없습니다."
} as const;

export const githubPagesBasePath = "/tiny-work-os-school";
