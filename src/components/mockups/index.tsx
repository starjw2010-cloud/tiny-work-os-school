...
export const RolePermissionMock = createMock("Role & Permission", "역할은 워크스페이스, 조직, 시스템 역할의 층으로 나뉠 수 있습니다.", ["Workspace roles: Owner / Admin / Member", "Guest roles: 제한 접근", "Org roles: Org Owner / Org Admin", "System roles: Security / Workflow / Apps"]);
...
export const EnterprisePlusMock = createMock("Enterprise+", "고객에게 설명할 때는 Enterprise+와 Enterprise 조직 표현을 우선 사용합니다. Enterprise Grid는 도움말 문서나 기존 자료에 남은 표현으로만 제한적으로 다룹니다.", ["Enterprise+ 플랜", "Enterprise 조직: 여러 워크스페이스", "조직 역할: Org Owner / Org Admin", "시스템 역할: 보안·앱·워크플로"]);
