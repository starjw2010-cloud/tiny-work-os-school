...
export const EnterprisePlusMock = createMock("Enterprise+", "고객-facing 설명에서는 Enterprise+와 Enterprise 조직 표현을 우선 사용합니다. Enterprise Grid는 공식 문서 잔존 표현 또는 기존/legacy 맥락에서만 제한적으로 다룹니다.", ["Enterprise+ 플랜", "Enterprise 조직: 여러 워크스페이스", "조직 단위 정책: 앱·보안·감사"]);
